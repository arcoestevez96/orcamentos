# Casa — Cama, Enxoval e Conforto Térmico

> Página de VIDA PESSOAL (categoria: casa/dia a dia). Decisões de compra e critérios técnicos para cama e conforto de sono.

## O que é

Página-guarda-chuva da categoria **vida pessoal → casa**, para não espalhar decisão de compra doméstica
em conversa solta. Cobre enxoval de cama (edredom, capa, travesseiro), critérios de escolha e o que já
foi pesquisado/decidido. Nota de arquitetura: por não ser específico do projeto ABRIU, o lugar canônico
desta página é o HUB (`~/projects/arco-wiki/`); mora aqui porque o hub não estava disponível no ambiente
em 2026-09-06. Ao sincronizar o hub, mover e deixar um ponteiro.

## Como funciona / Como usamos

### Termorregulação em cama: os dois níveis

- **Ativa (PCM — phase change material):** microcápsulas que absorvem calor quando o corpo esquenta e
  devolvem quando esfria. Tecnologias reais: **Outlast** (origem NASA) e **37.5**. Estudo da Outlast
  aponta ~50% de redução em suores noturnos. É o único nível que "adapta" temperatura de fato.
- **Passiva:** tecido/fibra respirável que dissipa calor e umidade (bambu/viscose, fibra oca, algodão,
  eucalipto/lyocell). Ajuda, mas não regula ativamente. **A maioria do que se vende no Brasil como
  "termorregulador" é isso** — tratar o rótulo como marketing até prova em contrário.

### Regras práticas aprendidas

- **Fofura e cooling brigam entre si.** Os edredons de cooling mais premiados (Rest Evercool+, Buffy
  Breeze de eucalipto) são finos e sem volume — gelados e sedosos, mas com cara de manta. Quem quer
  "nuvem" precisa de loft (pluma de ganso ou PCM com enchimento encorpado tipo Slumber Cloud).
- **Pluma de ganso:** comprar **100% pluma**. Versão "85% penas / 15% plumas" é mais barata mas a pena
  tem canhão e espeta. Pluma boa é termorreguladora por natureza (o loft respira) e dura até 4x mais
  que sintético.
- **A capa de edredom é o regulador térmico mais barato que existe** — troca de percal de algodão
  (200–300 fios) para bambu/viscose muda a sensação térmica mais do que se imagina, sem trocar o edredom.
- **Fleece/plush (coral + sherpa) é quente de verdade**, pensado para frio intenso; abafa em noite amena
  e forma bolinhas com o tempo.
- Fatores que viram a decisão: **clima do local** (litoral quente vs. serra) e **alergia a penas** em casa
  (se houver, pluma sai da lista).

### Pesquisa 2026-09 — Top 5 edredons (macio/fofo + termorregulação)

| # | Modelo | Tecnologia | Positivos | Negativos |
|---|---|---|---|---|
| 1 | **Slumber Cloud UltraCool** | ClimaDry by Outlast (PCM ativo) + capa 89% nylon/11% elastano | Único que junta regulação ativa **e** fofura; 2 gramaturas; hipoalergênico; lavável; garantia 180 dias | Caro; poucas cores; odor inicial; **não vende no Brasil** (só importando) |
| 2 | **Plumasul Kassette 100% pluma de ganso** | Capa algodão 233 fios; termorregulação natural do loft | Maciez e volume máximos; leve; até 4x mais durável; antiácaro; lavável | ~R$ 2.000; exige sol/ambiente seco; odor inicial; sem ajuste ativo |
| 3 | **Emma (fibra oca, estrutura espiral)** | Fibra oca + acolchoado de fluxo de ar (passiva, 4 estações) | Marca sólida no BR (~4,7/5, 1.500+ avaliações); lava a 60 °C; leve; anti-mofo | Passiva, não PCM; menos "nuvem" que pluma; preço/disponibilidade da linha de cama oscilam |
| 4 | **Altenburg Blend Sense (Plush/Sherpa)** | Coral Fleece 180 g/m² + Sherpa 300 g/m², enchimento Thermobonder 150 g/m² | Toque de pelúcia, o mais afagante; barato; fácil de achar | "Termorregulador" é marketing; **quente demais** p/ noite amena; forma bolinhas; lavagem restrita (40 °C, varal) |
| 5 | **Buddemeyer Toque de Pluma Plus** | Capa 100% algodão + microfibra extra macia | Toque muito suave; não alérgico; costura reforçada; barato e onipresente | Sem termorregulação real; abafa; pouco loft. Versão "Percalle" é mais fresca que a "Plus" |
